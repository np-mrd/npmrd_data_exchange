...
assignment_uuid_spreadsheet = "../assignment_uuid_master_list.csv"
...
for input_file in json_files:
    ...
    # Create the command
    command = f"python ../npmrd_curator_converter.py {input_file} {schema_file} {assignment_uuid_spreadsheet} {output_file}"
